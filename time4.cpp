...
int main() {
    ...
    if (numDescendentes.is_open()) {
        for (int numero = 20000; numero >= 1; --numero) {
    ...
    if (numAlternantes.is_open()) {
        for (int i = 1, j = 20000; i <= 10000 && j >= 10000; ++i, --j) {
            numAlternantes << i << " " << j << " ";
        }
